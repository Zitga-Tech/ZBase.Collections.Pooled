...
namespace Collections.Pooled.Generic
{
    public ref partial struct TempQueue<T>
    {
        ...
        public TempQueue(int capacity) : this(capacity, ArrayPool<T>.Shared) { }

        public TempQueue(IEnumerable<T> collection) : this(collection, ArrayPool<T>.Shared) { }

        // Creates a queue with room for capacity objects. The default initial
        // capacity and grow factor are used.
        public TempQueue(ArrayPool<T> pool)
        {
            _head = default;
            _tail = default;
            _size = default;
        ...
        // is used.
        public TempQueue(int capacity, ArrayPool<T> pool)
        {
            if (capacity < 0)
        ...
        public TempQueue(IEnumerable<T> collection, ArrayPool<T> pool)
        {
            if (collection == null)
