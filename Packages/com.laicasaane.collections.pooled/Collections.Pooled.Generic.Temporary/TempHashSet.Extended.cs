...
namespace Collections.Pooled.Generic
{
    ...
    {
        public TempHashSet(T[] items)
            : this(items.AsSpan(), null)
        { }

        public TempHashSet(T[] items, IEqualityComparer<T>? comparer)
        ...
        public TempHashSet(in ReadOnlySpan<T> span)
            : this(span, null)
        { }

        public TempHashSet(in ReadOnlySpan<T> span, IEqualityComparer<T>? comparer)
            : this(span, comparer, ArrayPool<int>.Shared, ArrayPool<Entry<T>>.Shared)
        { }

        public TempHashSet(in ReadOnlySpan<T> span, IEqualityComparer<T>? comparer, ArrayPool<int> bucketPool, ArrayPool<Entry<T>> entryPool)
