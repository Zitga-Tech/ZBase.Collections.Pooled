...
namespace Collections.Pooled.Generic
{
    ...
    {
        public TempQueue(T[] items) : this(items.AsSpan(), ArrayPool<T>.Shared)
        { }

        public TempQueue(T[] items, ArrayPool<T> pool) : this(items.AsSpan(), pool)
        { }

        public TempQueue(in ReadOnlySpan<T> span) : this(span, ArrayPool<T>.Shared)
        { }

        public TempQueue(in ReadOnlySpan<T> span, ArrayPool<T> pool)
        {
            _head = default;
            _tail = default;
            _size = default;
