...
namespace Collections.Pooled.Generic
{
    ...
    [Serializable]
    public partial struct ValueDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>, ISerializable, IDeserializationCallback where TKey : notnull
    {
        ...
        private void AddRange(IEnumerable<KeyValuePair<TKey, TValue>> collection)
        {
            ...
            {
                ValueDictionary<TKey, TValue> source = (ValueDictionary<TKey, TValue>)collection;
        ...
        /// the additional overhead on each <see cref="ValueDictionary{TKey, TValue}"/> instantiation, especially in AOT scenarios.
        /// </summary>
