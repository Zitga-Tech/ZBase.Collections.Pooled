...
namespace Collections.Pooled.Generic
{
    ...
    [Serializable]
    public partial class HashSet<T> : ICollection<T>, ISet<T>, IReadOnlyCollection<T>, IReadOnlySet<T>, ISerializable, IDeserializationCallback
    {
        ...
        public HashSet()
            : this((IEqualityComparer<T>?)null, ArrayPool<int>.Shared, ArrayPool<Entry<T>>.Shared)
        { }
        ...
        public HashSet(IEqualityComparer<T>? comparer, ArrayPool<int> bucketPool, ArrayPool<Entry<T>> entryPool)
        {
            ...
            : this(comparer, bucketPool, entryPool)
        {
            ...
            if (collection is HashSet<T> otherAsSet && EqualityComparersAreEqual(this, otherAsSet))
            {
        ...
        public HashSet(int capacity, IEqualityComparer<T>? comparer, ArrayPool<int> bucketPool, ArrayPool<Entry<T>> entryPool)
            : this(comparer, bucketPool, entryPool)
        {
            if (capacity < 0)
            {
        ...
        /// different equality comparers, then uniqueness assumption between sets break.
        /// </summary>
        internal static bool EqualityComparersAreEqual(HashSet<T> set1, SCG.HashSet<T> set2)
            => set1.Comparer.Equals(set2.Comparer);
        ...
        /// different equality comparers, then uniqueness assumption between sets break.
        /// </summary>
        internal static bool EqualityComparersAreEqual(SCG.HashSet<T> set1, HashSet<T> set2)
            => set1.Comparer.Equals(set2.Comparer);
