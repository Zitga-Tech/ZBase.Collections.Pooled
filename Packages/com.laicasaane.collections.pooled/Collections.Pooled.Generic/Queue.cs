...
namespace Collections.Pooled.Generic
{
    ...
    [Serializable]
    public partial class Queue<T> : IEnumerable<T>, IReadOnlyCollection<T>, IDeserializationCallback
    {
        internal T[] _array;
        ...
        public Queue() : this(ArrayPool<T>.Shared) { }

        public Queue(int capacity) : this(capacity, ArrayPool<T>.Shared) { }

        public Queue(IEnumerable<T> collection) : this(collection, ArrayPool<T>.Shared) { }

        // Creates a queue with room for capacity objects. The default initial
        // capacity and grow factor are used.
        public Queue(ArrayPool<T> pool)
        {
        ...
        // is used.
        public Queue(int capacity, ArrayPool<T> pool)
        {
            if (capacity < 0)
        ...
        public Queue(IEnumerable<T> collection, ArrayPool<T> pool)
        {
            if (collection == null)
