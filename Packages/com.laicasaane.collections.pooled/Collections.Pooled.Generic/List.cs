...
namespace Collections.Pooled.Generic
{
    ...
    [Serializable]
    public partial class List<T> : IList<T>, IReadOnlyList<T>, IDeserializationCallback
    {
        ...
        // as required.
        public List() : this(ArrayPool<T>.Shared)
        { }

        public List(int capacity) : this(capacity, ArrayPool<T>.Shared)
        { }

        public List(IEnumerable<T> collection) : this(collection, ArrayPool<T>.Shared)
        { }

        public List(ArrayPool<T> pool)
        {
            _items = s_emptyArray;
        ...
        //
        public List(int capacity, ArrayPool<T> pool)
        {
            if (capacity < 0)
        ...
        // given collection.
        //
        public List(IEnumerable<T> collection, ArrayPool<T> pool)
        {
            if (collection == null)
