...
{
    partial class Stack<T> : IDisposable
    {
        public Stack(T[] items) : this(items.AsSpan(), ArrayPool<T>.Shared)
        { }
        
        public Stack(T[] items, ArrayPool<T> pool) : this(items.AsSpan(), pool)
        { }

        public Stack(in ReadOnlySpan<T> span) : this(span, ArrayPool<T>.Shared)
        { }

        public Stack(in ReadOnlySpan<T> span, ArrayPool<T> pool)
        {
