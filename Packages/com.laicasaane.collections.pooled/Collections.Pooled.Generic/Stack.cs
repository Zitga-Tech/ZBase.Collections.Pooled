...
namespace Collections.Pooled.Generic
{
    ...
    [Serializable]
    public partial class Stack<T> : IEnumerable<T>, IReadOnlyCollection<T>, IDeserializationCallback
    {
        ...
        public Stack() : this(ArrayPool<T>.Shared)
        { }

        public Stack(int capacity) : this(capacity, ArrayPool<T>.Shared)
        { }

        public Stack(IEnumerable<T> collection) : this(collection, ArrayPool<T>.Shared)
        { }

        public Stack(ArrayPool<T> pool)
        {
        ...
        public Stack(int capacity, ArrayPool<T> pool)
        {
            if (capacity < 0)
        ...
        public Stack(IEnumerable<T> collection, ArrayPool<T> pool)
        {
            if (collection == null)
