...
namespace Collections.Pooled.ValueTypes
{
    ...
    [Serializable]
    public partial struct ValueHashSet<T> : ICollection<T>, ISet<T>, IReadOnlyCollection<T>, IReadOnlySet<T>, ISerializable, IDeserializationCallback
    {
        ...
        public ValueHashSet(int capacity, IEqualityComparer<T>? comparer)
            : this(capacity, comparer, ArrayPool<int>.Shared, ArrayPool<Entry<T>>.Shared)
        { }

        public ValueHashSet(IEqualityComparer<T>? comparer, ArrayPool<int> bucketPool, ArrayPool<Entry<T>> entryPool)
        {
            _buckets = default;
            _entries = default;
        ...
        public ValueHashSet(IEnumerable<T> collection, IEqualityComparer<T>? comparer, ArrayPool<int> bucketPool, ArrayPool<Entry<T>> entryPool)
        ...
        public ValueHashSet(int capacity, IEqualityComparer<T>? comparer, ArrayPool<int> bucketPool, ArrayPool<Entry<T>> entryPool)
            : this(comparer, bucketPool, entryPool)
        {
            if (capacity < 0)
            {
        ...
        private void ConstructFrom(ValueHashSet<T> source)
        {
            if (source.Count == 0)
            {
        ...
        /// <summary>Modifies the current <see cref="ValueHashSet{T}"/> object to contain all elements that are present in itself, the specified collection, or both.</summary>
        ...
        /// <summary>Modifies the current <see cref="ValueHashSet{T}"/> object to contain only elements that are present in that object and in the specified collection.</summary>
        /// <param name="other">The collection to compare to the current <see cref="ValueHashSet{T}"/> object.</param>
        ...
        /// <summary>Modifies the current <see cref="ValueHashSet{T}"/> object to contain only elements that are present either in that object or in the specified collection, but not both.</summary>
        /// <param name="other">The collection to compare to the current <see cref="ValueHashSet{T}"/> object.</param>
        public void SymmetricExceptWith(IEnumerable<T> other)
        {
            ...
            else if (other is SCG.HashSet<T> otherAsSCGSet && EqualityComparersAreEqual(this, otherAsSCGSet))
            {
        ...
        /// <summary>Determines whether a <see cref="ValueHashSet{T}"/> object is a proper superset of the specified collection.</summary>
        /// <param name="other">The collection to compare to the current <see cref="ValueHashSet{T}"/> object.</param>
        /// <returns>true if the <see cref="ValueHashSet{T}"/> object is a proper superset of <paramref name="other"/>; otherwise, false.</returns>
        ...
        /// <summary>Determines whether the current <see cref="ValueHashSet{T}"/> object and a specified collection share common elements.</summary>
        /// <param name="other">The collection to compare to the current <see cref="ValueHashSet{T}"/> object.</param>
        /// <returns>true if the <see cref="ValueHashSet{T}"/> object and <paramref name="other"/> share at least one common element; otherwise, false.</returns>
        ...
        /// <summary>Removes all elements that match the conditions defined by the specified predicate from a <see cref="ValueHashSet{T}"/> collection.</summary>
        ...
        /// <summary>
        /// Sets the capacity of a <see cref="ValueHashSet{T}"/> object to the actual number of elements it contains,
        ...
        private void SymmetricExceptWithUniqueHashSet(ValueHashSet<T> other)
        {
            foreach (T item in other)
            {
                if (!Remove(item))
        ...
        /// different equality comparers, then uniqueness assumption between sets break.
        /// </summary>
        internal static bool EqualityComparersAreEqual(ValueHashSet<T> set1, SCG.HashSet<T> set2)
            => set1.Comparer.Equals(set2.Comparer);
        ...
        /// different equality comparers, then uniqueness assumption between sets break.
        /// </summary>
        internal static bool EqualityComparersAreEqual(SCG.HashSet<T> set1, ValueHashSet<T> set2)
            => set1.Comparer.Equals(set2.Comparer);
